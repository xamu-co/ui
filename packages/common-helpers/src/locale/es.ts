...
export const localeBase: tLocaleBase = {
	...
	add: "Añadir",
	clear: "Limpiar",
	required_verification: "* Requerido. La información proporcionada será verificada.",
	previous: "Anterior",
	next: "Siguiente",
	send: "Enviar",
...
export const localeInput: tLocaleInput = {
	...
	select_filter_options: "Escribe para las opciones",
	select_filter_searching: "Buscando...",
	select_filter_no_content: "Escribe algo primero | Sin coincidencias",
	select_filter_select_value: "Seleccionar {value}",
...
export const localeModal: tLocaleModal = {
	modal_taking_too_long: "¿Está tardando demasiado?",
	swal: {
...
export const localeForm: tLocaleForm = {
	...
	form_id_number: "Número de identificación",
	form_date: "Fecha",
	form_datetime: "Fecha y hora",
	form_time: "Hora",
	form_complete_the_field: "Completa el campo",
	form_location: "Ubicación",
	form_invalid_field: "Este campo es inválido, complétalo adecuadamente",
	form_required_field: "Este campo es requerido y no puede estar vacío",
	form_use_valid_email: "Debes usar una dirección de correo electrónico válida",
	form_use_valid_phone: "Muy corto. Usa un número de teléfono válido",
	form_use_valid_cellphone: "Debes usar un número de celular válido",
	form_unmatching_passwords: "Las contraseñas no coinciden",
	form_invalid_data: "Información inválida",
...
export const localeTable: tLocaleTable = {
	...
	swal: {
		table_delete_node_title: "¿Estás seguro de que quieres eliminar este elemento?",
		...
		table_deleted_text: "Se eliminó el elemento, la lista se refrescará automáticamente",
		table_delete_nodes_title:
			"¿Estás seguro de que quieres eliminar este elemento? | ¿Estás seguro de que quieres eliminar estos {count} elementos?",
		...
		table_updated_text: "Se actualizó el elemento, la lista se refrescará automáticamente",
